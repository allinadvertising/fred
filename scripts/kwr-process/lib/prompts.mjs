...
const cleanValue = (value) => value.trim() || emptyFallback;

const prompt1Template = (values) => {
...
export const buildPromptOutputs = (values) =>
...
export const requiredFields = ['clientName', 'clientUrl', 'targetMarket', 'keywordUrls'];
